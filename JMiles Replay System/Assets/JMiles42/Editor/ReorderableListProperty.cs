...
public class ReorderableListProperty
{
	...
	public static implicit operator ReorderableListProperty(SerializedProperty input) { return new ReorderableListProperty(input); }

	public static implicit operator SerializedProperty(ReorderableListProperty input) { return input.Property; }
}