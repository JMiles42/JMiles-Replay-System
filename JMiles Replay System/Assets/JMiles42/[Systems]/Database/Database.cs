...
namespace JMiles42.Systems.Database
{
    ...
    public class Database: IDisposable
    {
        ...
        public IDbConnection GetNewConnection() { return new SqliteConnection(ConnectionString); }
        ...
        public static void AddToTable(Database db, string tableName, List<DataEntry> values)
        {
            ...
            db.SetQuery(string.Format("INSERT INTO {0}({1}) VALUES({2})", tableName, keysStr, valuesStr));
