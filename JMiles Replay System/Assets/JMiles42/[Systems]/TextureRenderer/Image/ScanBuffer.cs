...
namespace JMiles42.Systems.TextureRenderer
{
	...
	public class ScanBuffer
	{
		...
		public void FillTriangleH(Vertex v1, Vertex v2, Vertex v3, Colour col)
		{
			...
			minYVertex.Y += ImageData.HalfHeight;
			midYVertex.Y += ImageData.HalfHeight;
			maxYVertex.Y += ImageData.HalfHeight;

			minYVertex.X += ImageData.HalfWidth;
			midYVertex.X += ImageData.HalfWidth;
			maxYVertex.X += ImageData.HalfWidth;
