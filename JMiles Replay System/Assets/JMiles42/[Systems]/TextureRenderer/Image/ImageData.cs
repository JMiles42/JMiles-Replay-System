...
namespace JMiles42.Systems.TextureRenderer
{
    ...
    {
        [Half10Line] public int Width = 32;
        [Half01Line] public int Height = 32;
        ...
        [ImageDataArray] public byte[] Buffer;
        ...
        public void InitBuffer() { Buffer = new byte[Width * Height * Channels]; }

        public void Clear() { SetAllPixels(255, 255, 255); }
        public void Clear(Colour col) { SetAllPixels(col); }

        public void DrawPixel(int x, int y, byte r, byte g, byte b, byte a = 255, bool overflow = false) { DrawPixelMaster(x, y, r, g, b, a, overflow); }

        public void DrawPixel(int x, int y, Colour colour, bool overflow = false) { DrawPixelMaster(x, y, colour.R, colour.G, colour.B, colour.A, overflow); }
        ...
        public void DrawIndexedPixel(int index, Colour colour) { DrawIndexedPixel(index, colour.R, colour.G, colour.B, colour.A); }

        public void DrawRawIndexedPixel(int index, Colour colour) { DrawRawIndexedPixel(index, colour.R, colour.G, colour.B, colour.A); }
    }
}