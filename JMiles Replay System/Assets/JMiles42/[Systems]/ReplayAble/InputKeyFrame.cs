...
namespace ReplayAble {
	...
	public class InputButtonKeyFrame: KeyframeBase {
		...
		public override string ToString() { return string.Format("{0} was {1} At {2}", AxisName, Pressed? "Pressed" : "Released", Time); }
	}
	...
	public class InputAxisKeyFrame: KeyframeBase {
		...
		public override string ToString() { return string.Format("{0} was moved with a strength of{1} At {2}", AxisName, Strength, Time); }
	}
}